...
Acquire the source in the usual way:
    ...
    git clone https://github.com/jinseob-dev/xpchain-community-core-upgrade.git
...
way. This will install to `c:\workspace\xpchain`, for example:

    make install DESTDIR=/mnt/c/workspace/xpchain
...
It's not possible to build the XPChain Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the XPChain Core source code).
