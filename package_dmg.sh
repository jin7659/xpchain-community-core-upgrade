...
# Prioritize system tools over Anaconda/other paths to avoid tool incompatibility
export PATH="/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:${QT_PATH}/bin:${PATH}"
...
# Ensure all copied files are writable for macdeployqt
