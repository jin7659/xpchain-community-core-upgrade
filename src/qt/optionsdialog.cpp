    ...
    mapper(0)
{
    ...
    ui->xpchainAtStartup->setToolTip(ui->xpchainAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->xpchainAtStartup->setText(ui->xpchainAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openXPChainConfButton->setToolTip(ui->openXPChainConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->xpchainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openXPChainConfButton_clicked()
{
