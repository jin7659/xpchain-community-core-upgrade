...
#ifndef XPCHAIN_QT_BITCOINGUI_H
#define XPCHAIN_QT_BITCOINGUI_H
...
/**
  XPChain GUI main class. This class represents the main window of the XPChain UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class XPChainGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit XPChainGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~XPChainGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a xpchain wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
