...
#ifndef XPCHAIN_QT_GUIUTIL_H
#define XPCHAIN_QT_GUIUTIL_H
...
/** Utility functions used by the XPChain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "xpchain:" URI into recipient object, return true on successful parsing
