...
#ifndef XPCHAIN_QT_SPLASHSCREEN_H
#define XPCHAIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. XPChain Core initialization
...
#endif // XPCHAIN_QT_SPLASHSCREEN_H
