...
#ifndef XPCHAIN_QT_BITCOINUNITS_H
#define XPCHAIN_QT_BITCOINUNITS_H
...
/** XPChain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class XPChainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit XPChainUnits(QObject *parent);

    /** XPChain units.
      @note Source: https://en.xpchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XPC,
...
typedef XPChainUnits::Unit XPChainUnit;

#endif // XPCHAIN_QT_BITCOINUNITS_H
