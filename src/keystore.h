...
#ifndef XPCHAIN_KEYSTORE_H
#define XPCHAIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/xpchain/bips/blob/master/bip-0013.mediawiki
