...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount((COIN/100)*123456789).write(), "1234567.8900");
    BOOST_CHECK_EQUAL(ValueFromAmount(-COIN).write(), "-1.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(-COIN/10).write(), "-0.1000");

    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*1000000000000).write(), "1000000000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*100000000000).write(), "100000000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*10000000000).write(), "10000000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*1000000000).write(), "1000000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*100000000).write(), "100000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*10000000).write(), "10000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*1000000).write(), "1000000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*100000).write(), "100000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*10000).write(), "10000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*1000).write(), "1000.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*100).write(), "100.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*10).write(), "10.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN).write(), "1.0000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN/10).write(), "0.1000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.5")), 5000LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.5000")), 5000LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.8989")), 8989LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("1.0000")), 10000LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999999.999")), 209999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999999.9999")), 209999999999LL);
    ...
    BOOST_CHECK_THROW(AmountFromValue(ValueFromString("0.00019")), UniValue); //should fail
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.0001000000")), 1LL); //should pass, cut trailing 0
    BOOST_CHECK_THROW(AmountFromValue(ValueFromString("19e-5")), UniValue); //should fail

    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.19e-2")), 19); //should pass, leading 0 is present
    BOOST_CHECK_THROW(AmountFromValue(ValueFromString("922337203685477.5808")), UniValue); //overflow error
