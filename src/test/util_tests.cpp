...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney(COIN*1000000000000), "1000000000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(COIN*100000000000), "100000000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(COIN*10000000000), "10000000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(COIN*1000000000), "1000000000.00");
...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK(ParseMoney("1000000000000.00", ret));
    BOOST_CHECK_EQUAL(ret, COIN*1000000000000);
    BOOST_CHECK(ParseMoney("100000000000.00", ret));
    BOOST_CHECK_EQUAL(ret, COIN*100000000000);
    BOOST_CHECK(ParseMoney("10000000000.00", ret));
    BOOST_CHECK_EQUAL(ret, COIN*10000000000);
    BOOST_CHECK(ParseMoney("1000000000.00", ret));
    BOOST_CHECK_EQUAL(ret, COIN*1000000000);
