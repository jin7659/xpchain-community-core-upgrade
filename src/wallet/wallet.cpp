...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/xpchain/xpchain/pull/10340, but that change has been
    // postponed until after https://github.com/xpchain/xpchain/pull/10244 to
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign, bool fWriteLog)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-xpchain-address
 ...
 * https://xpchaintalk.org/?topic=54527, or
 * https://github.com/xpchain/xpchain/pull/1393.
 */
...
bool CWallet::Verify(std::string wallet_file, bool salvage_wallet, std::string& error_string, std::string& warning_string)
{
    ...
    try {
        ...
        error_string = strprintf(_("Error loading wallet %s. %s"), wallet_file, e.what());
        return false;
    }
